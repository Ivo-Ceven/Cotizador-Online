...
function renderArchiveMonth(monthKey, entries){
  ...
  /* Las tres tarjetas de plata significan otra cosa en un mes cerrado que en el
     pipeline vivo, así que acá se REETIQUETAN. Antes no: "Proyectado" mostraba
     exactamente el mismo número que "Facturado" (dos tarjetas distintas con el
     mismo valor) y bajo el rótulo "TOTAL PIPELINE" se leía "USD X perdido".
     renderPipeline() vuelve a poner los rótulos del pipeline en cada pasada,
     así que volver de un mes archivado no deja estos pegados. */
  ...
  // El pipeline activo rotula estas pastillas; el archivo las dejaba sin rótulo.
